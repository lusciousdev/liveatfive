...
class TwitchVideo(models.Model):
  vod_id = models.CharField(max_length = 128, default = "")
  stream_id = models.CharField(max_length = 128, default = "")
  user_id = models.CharField(max_length = 128, default = "")
  user_login = models.CharField(max_length = 128, default = "")
  ...
  viewable = models.CharField(max_length = 64, default = "")
  view_count = models.IntegerField(default = 0)
  language = models.CharField(max_length = 32, default = "")
  vod_type = models.CharField(max_length = 64, default = "")
  duration = models.CharField(max_length = 64, default = "")
